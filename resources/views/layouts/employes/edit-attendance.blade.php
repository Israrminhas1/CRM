    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                ...
                @endif
                <form role="form" method="post" action="{{url('edit-attendance/'.$attendance->id)}}" >
                    @csrf
                    <div class="form-body">
                            ...
                            <div class="form-group c_form_group {{(@$errors->any() && $errors->first('type_id')) ? 'has-error' : 'has-info'}} ">
                                <div class="input-group" >
                                    ...
                                    <select class="form-control basic-single" id="type_id" name="type_id" >
                                        ...
                                        <option value="Clock In" {{old('type_id',$attendance->attendance_type) == "Clock In" ? "selected" : ""}}>Clock In</option>
                                        
                                        <option value="Clock Out" {{old('type_id',$attendance->attendance_type) == "Clock Out" ? "selected" : ""}}>Clock Out</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group c_form_group {{(@$errors->any() && $errors->first('attendance_time')) ? 'has-error' : 'has-info'}}">
                                <label>Date</label>
                                <div class="input-group">
                                    <input data-provide="datepicker" name="attendance_date"  value="{{old('attendance_time',$attendance->attendance_date)}}" data-date-autoclose="true" class="form-control" placeholder="Select date">
                        ...
                        <div class="col-md-6">
                            <div class="form-group c_form_group {{(@$errors->any() && $errors->first('attendance_time')) ? 'has-error' : 'has-info'}}">
                                <div class="input-group">
                                    ...
                                    <input type="time" name="attendance_time" class="form-control"  value="{{old('attendance_time',$attendance->attendance_time)}}" >
                                        @if ($errors->any() && $errors->first('attendance_time'))
                                        <span class="text-danger w-100 small">{{$errors->first('attendance_time')}}</span>
                                    @endif
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group c_form_group {{(@$errors->any() && $errors->first('comment')) ? 'has-error' : 'has-info'}}">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="comment" class="form-control"  value="{{old('comment',$attendance->comment)}}" >
