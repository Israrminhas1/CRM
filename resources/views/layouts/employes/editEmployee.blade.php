    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                ...
                @endif
                    <form role="form" method="post" action="{{url('edit-employees/'.$employee->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('full_name')) ? 'has-error' : 'has-info'}} ">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="full_name" class="form-control"  value="{{old('full_name',$employee->full_name)}}" placeholder="Full Name">
                            ...
                            <div class="col-md-6">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('father_name')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="father_name" class="form-control"  value="{{old('father_name',$employee->father_name)}}" placeholder="Father Name">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group c_form_group {{(@$errors->any() && $errors->first('basic_salary')) ? 'has-error' : 'has-info'}}">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="basic_salary" class="form-control"  value="{{old('basic_salary',$employee->basic_salary)}}" placeholder="Basic Salary E.g 5000">
                            ...
                            <div class="col-md-6">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('salary')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="salary" class="form-control"  value="{{old('salary',$employee->salary)}}" placeholder="Salary">
                            ...
                            <div class="col-md-6">
                                <div class="form-group c_form_group">
                                    ...
                                    <select class="form-control single2" name="breakupType" >
                                        ...
                                        <option value="{{  $breakupType->id }}" {{old('breakupType',$employee->BreakUpTypeId) == $breakupType->id ? "selected" : ""}}> {{  $breakupType->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('dob')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input type="text"  data-provide="datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd" name="dob" class="form-control"  value="{{old('dob',$employee->dob)}}" placeholder="Date Of Birth">
                                ...
                                <div class="form-group c_form_group">
                                    <label>Gender</label>
                                        ...
                                        <label class="fancy-radio custom-color-green" style="width: auto;margin-bottom: 0px">
                                            <input type="radio" id="radio14" value="M" name="gender" class="" {{old('gender',$employee->gender) == 'M' ? "checked" : "checked"}} >
                                            <span> <i></i>  Male </span>

                                        </label>
                                        <label class="fancy-radio custom-color-green" style="width: auto;margin-bottom: 0px">
                                            <input type="radio" id="radio15" value="F" name="gender" class=""  {{old('gender',$employee->gender) == 'F' ? "checked" : ""}} >
                                            <span> <i></i>  Female </span>

                                        </label>
                                        <label class="fancy-radio custom-color-green" style="width: auto;margin-bottom: 0px">
                                            <input type="radio" id="radio16" value="O" name="gender" class="" {{old('gender',$employee->gender) == 'O' ? "checked" : ""}}>
                                            <span> <i></i>  Other </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('current_address')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="current_address" class="form-control"  value="{{old('current_address',$employee->emp_address)}}" placeholder="Current Address">
                            ...
                            <div class="col-md-6">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('mobile')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="mobile" class="form-control"  value="{{old('mobile',$employee->mobile_phone)}}" placeholder="Mobile">
                                ...
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('country')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <select name="country" class="form-control single2">
                                            <option value="{{old('country',$employee->country)}}"  selected="selected">{{!empty(old('country')) ? old('country') : "$employee->country"}}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('country_contact')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="country_contact" class="form-control"  value="{{old('country_contact',$employee->contact_name)}}" placeholder="Home Country Contact">
                                            @if ($errors->any() && $errors->first('country_contact'))
                                            <span class="help-block">{{$errors->first('country_contact')}}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('country_phone')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="country_phone" class="form-control"  value="{{old('country_phone',$employee->country_phone)}}" placeholder="Home Country Phone">
                                            @if ($errors->any() && $errors->first('country_phone'))
                                            <span class="help-block">{{$errors->first('country_phone')}}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('country_address')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="country_address" class="form-control"  value="{{old('country_address',$employee->permanent_address)}}" placeholder="Home Country Address">
                                            @if ($errors->any() && $errors->first('country_address'))
                                            <span class="help-block">{{$errors->first('country_address')}}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('designation')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="designation" class="form-control"  value="{{old('designation',$employee->designation)}}" placeholder="Designation">
                            ...
                            <div class="col-md-6">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('join_date')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input type="text"  data-provide="datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd" name="join_date" class="form-control"  value="{{old('join_date',$employee->joining_date)}}" placeholder="Joining Date">
                                ...
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('visa_title')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <select name="visa_title" class="form-control">
                                            {{-- <option value="{{old('visa_title',$employee->visa_title)}}"  selected="selected">Select Visa Title</option>  --}}
                                            <option  value="">Select Visa Title</option>
                                            <option {{old('visa_title',$employee->visa_title) == "Visit" ? "selected" : ""}}>Visit</option>

                                            <option {{old('visa_title',$employee->visa_title) == "Resident" ? "selected" : ""}}>Resident</option>
                                            <option {{old('visa_title',$employee->visa_title) == "Family" ? "selected" : ""}}>Family</option>
                                        </select>

                                            @if ($errors->any() && $errors->first('visa_title'))
                                            <span class="help-block">{{$errors->first('visa_title')}}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group c_form_group {{(@$errors->any() && $errors->first('visa_expiry')) ? 'has-error' : 'has-info'}}">
                                    <div class="input-group">
                                        ...
                                        <input name="visa_expiry" type="text"  data-provide="datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd" class="form-control"  value="{{old('visa_expiry',$employee->visa_expiry_date)}}" placeholder="Visa Expiry">
                                            @if ($errors->any() && $errors->first('visa_expiry'))
                                            <span class="help-block">{{$errors->first('visa_expiry')}}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <img height="200" width="200" id="thisimage" src="{{ asset($employee->attachment) }}">
                        ...
                        <div class="form-actions noborder">
                            ...
                            <a class="btn btn-default"  href="{{url('list-employees')}}">Cancel</a>
                        </div>
                    </form>
                    <!-- END FORM-->
            </div>
