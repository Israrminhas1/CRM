...
<div class="row clearfix">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2>Registered Leaves</h2>
                <ul class="header-dropdown dropdown">
<li>   @if(in_array('add-leaves', $rights_array))
    <a href="{{url('add-leaves')}}" class="btn btn-primary theme-bg btn-round plain text-white"><i class="fa fa-plus"></i></a>
    @endif</li>
