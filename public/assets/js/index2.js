...
(function(H) {
  H.seriesTypes.timeline.prototype.init = function() {
    var series = this;
    H.Series.prototype.init.apply(series, arguments);
    H.addEvent(series, 'afterTranslate', function() {
      ...
      if (series.points.length === 1) {
        closestPointRangePx = series.chart.plotWidth
      }
    ...
    // property.
    H.addEvent(series, 'drawDataLabels', function() {
    ...
    H.addEvent(series.chart, 'afterHideOverlappingLabel', function() {
